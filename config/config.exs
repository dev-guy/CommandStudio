...
config :ash,
  ...
  known_types: [AshPostgres.Timestamptz, AshPostgres.TimestamptzUsec, Money],
...
config :cns, Cns.Mailer, adapter: Swoosh.Adapters.Local
...
config :cns, CnsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CnsWeb.ErrorHTML, json: CnsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Cns.PubSub,
...
config :cns, Oban,
  ...
  plugins: [
    {Oban.Plugins.Cron,
     crontab: [
       {"* * * * *", Cns.Scheduler.Workers.DispatchDueCommands}
     ]}
  ]
...
config :cns,
  ...
  ash_domains: [Cns.Accounts, Cns.Scheduler],
...
config :ex_cldr, default_backend: Cns.Cldr
